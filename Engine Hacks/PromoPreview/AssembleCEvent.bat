...
SET ref="C:\Users\dev\Documents\GitHub\FE-CLib\reference\FE8U-20190316"
SET lyn="C:\devkitPro\lyn.exe"

@rem compile into an object file
%gcc% -mcpu=arm7tdmi -mabi=aapcs -mthumb -mthumb-interwork -fomit-frame-pointer -ffast-math -fno-toplevel-reorder -mlong-calls -I "C:\Users\dev\Documents\GitHub\FE-CLib\include" -Os -c %1 -o "%~n1.o"
