...
%gcc% -mcpu=arm7tdmi -mabi=aapcs -mthumb -mthumb-interwork -fomit-frame-pointer -ffast-math -fno-toplevel-reorder -mlong-calls -I "C:\Users\baron\Documents\GitHub\Devvy-Hack\Tools\FE-CLib\include" -O2 -c %1 -o "%~n1.o"
