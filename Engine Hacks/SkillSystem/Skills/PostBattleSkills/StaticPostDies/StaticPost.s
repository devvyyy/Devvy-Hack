...
.equ StaticExplodeEvent, StaticPanicID+4
.equ GetUnitsInRange, StaticExplodeEvent+4
.thumb
push	{r4-r7,lr}
@check if dead
ldrb	r0, [r4,#0x13]
...
ldrb	r0, [r5,#0x13]
cmp	r0, #0x00
bne	End @if NOT dead, end

@Check if there are enemies in 4 spaces
...
mov	lr, r0
ldr	r0, StaticExplodeEvent	@this event is just "play some sound effects"
...
ldrb	r0, [r4,#0x16]	@spd
mov	r1, #0x02
@swi	#0x06		@r0 spd/2 dont divide this time
